...
namespace VichoRISC.Components {
	...
	public partial class Cpu {
		...
		public void BitwiseNot(ref int destinationRegister, ref int sourceRegister) {
		...
		public void Move(ref int destinationRegister, ref int sourceRegisterOrImmediate) {
